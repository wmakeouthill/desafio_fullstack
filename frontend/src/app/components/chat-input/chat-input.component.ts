...
export class ChatInputComponent {
    ...
    readonly providersDisponiveis = computed(() => {
        ...
        const lista: { value: AIProvider; label: string; available: boolean; model: string; fallback_models: string[]; icon: string }[] = [];
        ...
        if (p.providers.openai) {
            lista.push({
                ...
                model: p.providers.openai.model,
                fallback_models: p.providers.openai.fallback_models || [],
                icon: '🤖'
            });
        }
        ...
        if (p.providers.gemini) {
            lista.push({
                ...
                model: p.providers.gemini.model,
                fallback_models: p.providers.gemini.fallback_models || [],
                icon: '✨'
            });
        }
